...
function getOverlayLayers(el, switchId){
    ...
    switchMap = {"precinctsonoffswitch": "vtd_20190114_utm","countyonoffswitch": "cty2010", "cityonoffswitch":"mcd2015", "cononoffswitch":"cng2012", "ssonoffswitch":"sen2012_vtd2015", "shonoffswitch":"hse2012_vtd2015"}
    ...
    if(el.is(':checked')){
    	...
    	if(typeof overlayLayers[switchMap[switchId]] === 'undefined'){
    		overlayLayers[switchMap[switchId]] = L.tileLayer.wms('https://www.gis.leg.mn/cgi-bin/mapserv?map=/web/gis/iMaps/precincts/data/mapserver.map', {
			    format: 'image/png',
			    transparent: false,
			    minZoom: 6,
			    zIndex: 3,
...
function addMemberData(memberData){
	...
	if (typeof memberData.features[0] !== "undefined"){
	    ...
	    $('.precinctTitle').html('2018 Precinct Information');
	    $('#precinctData').html('Precinct - ' + memberData.features[3].properties.district).delay("slow").fadeIn();
	    $('#precinctlink').attr('title', 'Find Polling Place');
