...
<div id="legContainerMain" class="container py-4 px-0 px-md-3"> <!--use overflow-hidden to hide content-->
	<div class="row">
		<div class="col py-md-1">
			<h1 class="leg-portal-header text-center mb-1"><span class="d-none d-sm-inline">Geographic Information Services |</span> <span class="text-secondary">Precinct Finder</span></h1>
		</div>
	</div>
	<div class="row">
					...
					<div id="officials">
						...
						<div class='mnhouse'>
							...
							<div class="contact-info float-right">
								<a id='mnhouselink' target="_blank" class="btn btn-outline-primary btn-sm" title><i class="fas fa-address-card"></i></a>
							</div>
						...
						<div class='mnsenate'>
							...
							<div class="contact-info float-right">
								<a id="mnsenlink" target="_blank" class="btn btn-outline-primary btn-sm" title><i class="fas fa-address-card"></i></a>									
							</div>
							<div class="member-info">
							...
							<div class='ushouse'>
								...
								<div class="contact-info float-right">
									<a id="ushouselink" target="_blank" class="btn btn-outline-primary btn-sm" title><i class="fas fa-address-card"></i></a>				
								</div>
							...
							<div class='ussenate1'>
								<div class="membersublist">
									...
									<div class="contact-info float-right">
										<a id="ussenatelink" target="_blank" class="btn btn-outline-primary btn-sm"  title><i class="fas fa-address-card"></i></a>				
									</div>
							...
							<div class='ussenate2'>
								<div class="membersublist">
									...
									<div class="contact-info float-right">
										<a id="ussenate2link" target="_blank" class="btn btn-outline-primary btn-sm" title><i class="fas fa-address-card"></i></a>				
									</div>
